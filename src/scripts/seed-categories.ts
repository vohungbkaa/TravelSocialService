...
async function main() {
  ...
  const markerIconSeeds = [
    ...
    { key: 'masks-theater', name: 'Văn hóa', iconUrl: 'https://api.iconify.design/lucide:masks-theater.svg?color=%23ffffff', markerColor: '#a855f7' },
    { key: 'monument', name: 'Lịch sử', iconUrl: 'https://api.iconify.design/lucide:monument.svg?color=%23ffffff', markerColor: '#10b981' },
    ...
    { key: 'campground', name: 'Vui chơi / Dã ngoại', iconUrl: 'https://api.iconify.design/lucide:campground.svg?color=%23ffffff', markerColor: '#06b6d4' },
